    ...
    <div className="form-container">
      <fieldset>
        ...
        <form onSubmit={formSubmitHandler}>
          ...
          <input type="text" name="firstName" onChange={handleInputChange} className="formentity"/>
          {formError.firstName && <p className="err">{formError.firstName}</p>}
          

          <label> Last Name:</label>
          <input type="text" name="lastName" onChange={handleInputChange} className="formentity"/>
          {formError.lastName && <p className="err">{formError.lastName}</p>}

          <label> Email Address:</label>
          <input type="text" name="email" onChange={handleInputChange} className="formentity"/>
          {formError.email && <p className="err">{formError.email}</p>}

          <label> Phone Number:</label>
          <input type="text" name="phone" onChange={handleInputChange} className="formentity"/>
